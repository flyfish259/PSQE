...
class cfg():
    ...
    def get_args(self):
        ...
        # --------- EVA -----------
        parser.add_argument("--data_split", default="fr_en", type=str, help="Experiment split", choices=["V2", "V1", "zh_en", "ja_en", "fr_en", "norm"])#todo  v1
        ...
        parser.add_argument("--use_surface", type=int, default=1, help="whether to use the surface")
